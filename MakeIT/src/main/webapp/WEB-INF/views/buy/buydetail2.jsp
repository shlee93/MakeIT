                       ...
                       <div class="col-md-10">
                        <c:if test="${detailList.GRADENAME == '브론즈' }">
                              ...
                              <c:if test="${detailList.GRADENAME == '실버' }">
                                 <p><img alt="" src="${path }/resources/image/silverGrade.png" style="max-width: 50px;max-height: 50px;"></p>
                              </c:if>
                              <c:if test="${detailList.GRADENAME == '골드' }">
                                 <p><img alt="" src="${path }/resources/image/goldGrade.png" style="max-width: 50px;max-height: 50px;"></p>
                              </c:if>
                              <c:if test="${detailList.GRADENAME == '플래티넘' }">
                                 <p><img alt="" src="${path }/resources/image/platinumGrade.png" style="max-width: 50px;max-height: 50px;"></p>
                              </c:if>
                              <c:if test="${detailList.GRADENAME == '다이아몬드' }">
                                 <p><img alt="" src="${path }/resources/image/diamodeGrade.png" style="max-width: 50px;max-height: 50px;"></p>
                              </c:if>
