...
<div class="col-md-12 insert-form">
	...
	<div class="form-group">
	  ...
	  <div class="col-md-6">
	  	<textarea rows="10" cols="100" placeholder="질문을 입력해주세요" id="qna-content" name="qna-content">${qna.QNACONTENT }</textarea>
	  </div>
	</div>
	
	<div class="form-group">
	  	<button id="update-qna-end" class="btn btn-outline-info slidetopleft">수정</button>
