            ...
            <form name='signupform' id="signupform" action="${path }/member/memberUpdateEnd.do" method="POST" onsubmit='return fn_enroll_validate()' enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-2">
                        <input type="text" class='form-control' id='memberAccount' name='memberAccount' placeholder="계좌번호 입력" maxlength="20" value="${member.ACCOUNT }" required>   
                    </div>
                    <div class="col-md-3 mb-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-1 mb-2">
                        <input type="text" id='memberEmail' maxlength="20" name='memberEmail' class='form-control' value='${email }' placeholder="이메일" required>
                    </div>
                    <div class="col-md-1 mb-2 memberNo-center">
                        <span>@</span>
                    </div>
                    <div class="col-md-2 mb-2">
                    	<input type="text" class="form-control" maxlength="20" id="joinEmailDomain" name="joinEmailDomain" value='${domain }' placeholder="직접입력" required>
                    </div>
                    <div class="col-md-2 mb-2">
