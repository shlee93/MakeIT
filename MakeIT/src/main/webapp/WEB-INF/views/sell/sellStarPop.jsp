...
<script>
   ...
   function fn_submit()
   {
      ...
      {
         reviewFrm.action="${path }/sell/modReviewEnd.do";
      }
      else
      {
         reviewFrm.action="${path }/sell/writeReviewEnd.do";
      }
      reviewFrm.submit();
...
<body>
   ...
   <form action="${path }/sell/writeReviewEnd.do" method="post" name="reviewFrm">
      ...
      <div style="padding:10px">
         ...
         <input type="hidden" id="sellno" name="sellno" value="${sellno }">
