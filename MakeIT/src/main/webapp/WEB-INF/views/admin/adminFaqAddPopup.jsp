    ...
    <div>
    		...
    		<fieldset>
	    		...
	    		<c:if test="${not empty categoryList }">
	    			<c:forEach items="${categoryList }" var="category">
		    			<option class="category-name" value="${category.FAQNACATEGORYNO }">${category.FAQNACATEGORYNAME }</option>
	    			</c:forEach>
	    		</c:if>
	    		</select>
    		</fieldset>
        ...
        <br style="clear:both">
            <div class="form-group col-md-4 ">                                
                ...
                <textarea class="form-control input-sm " type="textarea" id="question" placeholder="질문" rows="7"></textarea>
                                    
            </div>
            <div class="form-group col-md-4 ">                                
                <label id="qnaLabel" for="answer">답변 </label>
                <textarea class="form-control input-sm " type="textarea" id="answer" placeholder="답변" rows="7"></textarea>
